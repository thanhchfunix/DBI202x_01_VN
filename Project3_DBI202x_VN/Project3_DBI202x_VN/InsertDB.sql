...
producer. Anh h?c t?p t?i tr??ng ??i h?c The Art Institute ? M? và khi tr? v? Vi?t Nam, 
anh gia nh?p SpaceSpeakers, anh gia nh?p SpaceSpeakers', 'binzdapoet')
insert into Channel values(N'ZendVN - H?c L?p Trình Online', N'chia s? mi?n phí các video
t? h?c tr?c tuy?n v? l?p trình web, l?p trình di ??ng, thi?t k? web, k? n?ng m?m, k? n?ng xin vi?c, t? v?n ngh? nghi?p, ...', 'zendvn')
...
'public', 1491404, 2, 1)
insert into Videos values ('2020-08-02 20:00:00', N'S?N TÙNG M-TP | OPPO RENO4 LIVE PERFORMANCE',
N'S?n Tùng MTP', 'public', 1008792, 2, 1)
insert into Videos values ('2020-07-20 20:00:00', N'S?N TÙNG M-TP | CÓ CH?C YÊU LÀ ?ÂY | ONLINE STAGE',
N'S?n Tùng MTP', 'public', 2507938, 2, 1)
insert into Videos values ('2019-07-05 20:00:00', N'S?N TÙNG M-TP | HÃY TRAO CHO ANH ft. Snoop Dogg | Official MV',
N'S?n Tùng MTP', 'public', 206000000, 2, 1)
insert into Videos values ('2016-08-03 20:00:00', N'Chúng Ta Không Thu?c V? Nhau | Official Music Video | S?n Tùng M-TP',
N'S?n Tùng MTP', 'public', 175000000, 2, 1)
go
